import { uuidv4, uuidv7 } from '../src/libs/uuidv7.js';
import { isValidUuidv4 } from '../src/validation.js';
...
describe('uuidv7', () => {
  it('returns a valid UUID string', () => {
    expect(isValidUuidv4(uuidv7())).toBe(true);
  });
...
describe('isValidUuid', () => {
  ...
  it('returns false for non-string', () => {
    expect(isValidUuidv4(42)).toBe(false);
