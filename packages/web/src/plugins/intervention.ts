...
export interface InterventionTracker {
  ...
  dismissed(
    props: InterventionEventProps & { dismissed_reason?: string },
  ): void;
   ...
   */
  suppressed(
    props: InterventionEventProps & { suppressed_reason: string },
  ): void;
  /**
...
export function mountIntervention(tracker: WinceClient): InterventionTracker {
  ...
  function emit(event: string, props: InterventionEventProps): void {
    ...
    tracker.track<InterventionType>(event, {
      ...props,
